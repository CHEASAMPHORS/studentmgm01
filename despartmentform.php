<?php
    ...
    if(isset($_POST['save'])){
       ...
       $sql = "insert into department(name,status) values('$department','$d_status')";
...
<?php
    ...
    if(isset($_GET['id'])){
        ...
        if($delete){
            header("location:despartmentcontent.php");
            die();
        }
    }
}
                ...
                <form action="" method="post">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input class="form-control mt-3" placeholder="Add status" name="status">
                        </div>
                        <div class="col-4">
